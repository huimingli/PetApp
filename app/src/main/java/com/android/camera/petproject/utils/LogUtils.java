...
import com.android.camera.petproject.config.AppConfig;
import java.util.List;

public class LogUtils {

	/** 日志输出时的TAG */
	private static String mTag = AppConfig.APP_TAG;
	/** 日志输出级别NONE */
	...
	/** 是否允许输出log */
	private static int mDebuggable = AppConfig.LOG_DEBUG_LEVEL;
